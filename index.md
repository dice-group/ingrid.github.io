...
### A list of basic SPARQL queries from the [INGRID-KG endpoint](https://graffiti.data.dice-research.org/sparql/).
...
Limit 10
```
### List of advanced SPARQL queries from the [INGRID-KG endpoint](https://graffiti.data.dice-research.org/sparql/).
...
```
Show the period of time in which a sprayer painted each graffitis (useing the recording date) with the longest period for a sprayer in the knowledge graph
